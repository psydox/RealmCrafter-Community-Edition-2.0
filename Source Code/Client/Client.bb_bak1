...
Repeat
	...
	Select Bloom
		Case 1
	;Custom bloom
	;CustomPostprocessGlow GlowAlpha, GlowDarkPasses, GlowBlurPasses, GlowBlurRadius, GlowQuality, GlowRed, GlowGreen, GlowBlue, GlowAlphaTexture
	...
	If ResolutionType = 1 ; 16:9 ratio
 		Text 1200,40,"Dragon Gate Alpha"
		Text 1200,60,"Polygons: " + TrisRendered()
		Text 1200,80,"FPS: " + FramesPS()
	Else
		Text 1100,40,"Dragon Gate Alpha"
...
; 3rd person
	If CamMode = 0
		...
		RotateEntity(Cam, CamPitch#, CamYaw# + EntityPitch#(Me\CollisionEN) + 180.0, 0.0) ;[~~~]
		...
		If Result <> 0 Then MoveEntity(Cam, 0.0, 0.0, 0.12) ;0.0, 0.0, 0.1

...
Function LoadArea(Name$, CameraEN, DisplayItems = False, UpdateRottNet = False)
	...
	;&&& Water edit 
    BumpTexA = LoadAnimTexture("Data\Textures\Water\water_anim.jpg", 9, 64, 64, 0, 32) 
	...
	If F = 0 Then Return False
		...
		If DisplayItems = False
			; Progress bar
			LoadProgressBar = GY_CreateProgressBar2(0, 0.3, 0.9, 0.4, 0.035, 0, 100, 255, 255, 255, -3012)
			; Preset image

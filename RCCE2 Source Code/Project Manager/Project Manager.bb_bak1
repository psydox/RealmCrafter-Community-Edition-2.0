...
Local E.Event	
	...
	;News Tab
		Case BANO
			ExecFile("http://realmcrafterce.com/forum/viewforum.php?f=2")
		Case BFANO
			ExecFile("http://realmcrafterce.com/forum/viewforum.php?f=2")
	...
	;Support Tab
		...
		Case OSCR
			ExecFile("http://realmcrafterce.com/forum/viewforum.php?f=7")
		Case OTUT
			ExecFile("http://realmcrafterce.com/forum/viewforum.php?f=6")
		Case OSRD
			ExecFile("http://realmcrafterce.com/forum/viewforum.php?f=18")
		Case OSTU
			ExecFile("http://realmcrafterce.com/forum/viewforum.php?f=17")
		Case ORYD
